...
public class FileWritersJavaIo {
    ...
    public static void main(String[] args) {
        ...
        try (PrintStream ps = new PrintStream("C:/Users/sotik/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file-ps.txt")) {
           // fileWriter("C:/Users/sotik/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file.txt");
           // bufferedWriter(file);
            ...
            System.out.println("Το αρχείο δεν δημιουργήθηκε  ή συνέβει κάποιο σφάλμα κατά την εγγραφή");
        }
    }
